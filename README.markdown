...
2. **Загрузи ZIP-архивы**:
   - **Перетащи файлы**: Перетащи ZIP-архивы с DICOM-файлами или изображениями в зону drag-and-drop (пунктирная рамка с иконкой загрузки).
   - **Или выбери файлы**: Нажми на зону drag-and-drop, чтобы открыть диалог выбора файлов, и выбери ZIP-архивы.
